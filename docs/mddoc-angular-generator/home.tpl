<h1>Angular Youtube</h1>

<blockquote>Youtube videos with custom configurable controls for Angular.js</blockquote>

<div class="bs-callout bs-callout-danger">
    <h4>THIS IS A WORK IN PROGRESS AND ITS CHANGING RAPIDLY, USE AT OWN RISK</h4>
</div>
