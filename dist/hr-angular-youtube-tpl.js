...
(function (angular) {
    ...
    angular.module('hrAngularYoutube')
        .directive('youtubePlayer', ['youtube', function (youtube) {
            var playerAttrs = ['id', 'height', 'width'], playerVarAttrs = ['autohide', 'autoplay', 'ccLoadPolicy', 'color', 'controls',
            ...
            return {
                ...
                link: function (scope, elm, attrs, controllers) {
                    var youtubePlayerCtrl = controllers[0], ngModelCtrl = controllers[1];
        ...
        .directive('ytSlider', ['$parse', '$document', function ($parse, $document) {
            return {
                ...
                link: function (scope, elm, attrs, youtubePlayerCtrl) {
                    var slideDown = $parse(attrs.ytSliderDown), sliderMove = $parse(attrs.ytSliderMove), sliderUp = $parse(attrs.ytSlider);
            ...
            return {
                ...
                link: function (scope, elm, attrs, ctrls) {
                    ...
                    youtubePlayerCtrl.getPlayer().then(function (player) {
                        ...
                        var $played = angular.element(elm[0].querySelector('.hr-yt-played')), $loaded = angular.element(elm[0].querySelector('.hr-yt-loaded')), $handle = angular.element(elm[0].querySelector('.hr-yt-handle'));
...
(function (angular) {
    angular.module('hrAngularYoutube')
        ...
        return {
            ...
            scope: {},
            link: function (scope, elm, attrs, youtubePlayerCtrl) {
                var $volumeBar = angular.element(elm[0].querySelector('.hr-yt-volume-hr-bar')), $settedBar = angular.element(elm[0].querySelector('.hr-yt-setted')), $handle = angular.element(elm[0].querySelector('.hr-yt-handle'));
                youtubePlayerCtrl.getPlayer().then(function (player) {
...
(function (angular) {
    ...
    angular.module('hrAngularYoutube')
        ...
        function ($q, $interval, $rootScope, youtubeReadableTime, youtubeQualityMap, youtubeUuid, YoutubeMarkerList, hrAngularExtend) {
...
System.register("src/ng-helper/component", ["angular"], function (exports_1, context_1) {
    "use strict";
...
System.register("src/ng-helper/compose-link", [], function (exports_2, context_2) {
    "use strict";
    ...
    exports_2("composeLinkFn", composeLinkFn);
    return {
        setters: [],
        execute: function () {
        }
...
System.register("src/ng-helper/lifecycle", [], function (exports_3, context_3) {
    "use strict";
    ...
    exports_3("mockNgOnInitLink", mockNgOnInitLink);
    /**
    ...
    exports_3("mockNgAfterViewInit", mockNgAfterViewInit);
    /**
     * Waits until all watchers are not falsy and calls ngAfterViewInit on the
     * the controller.
     * See http://learnangular2.com/lifecycle/
    ...
    exports_3("mockNgAfterContentInit", mockNgAfterContentInit);
    ...
    exports_3("mockNgOnInitFromAttr", mockNgOnInitFromAttr);
    return {
        setters: [],
        execute: function () {
        }
...
System.register("src/ng-helper/require", ["src/ng-helper/compose-link", "src/ng-helper/lifecycle"], function (exports_4, context_4) {
    "use strict";
    ...
    exports_4("bindRequireToCtrl", bindRequireToCtrl);
    ...
    exports_4("bindToCtrlCallOnInit", bindToCtrlCallOnInit);
...
System.register("src/ng-helper/facade", ["src/ng-helper/component", "src/ng-helper/compose-link", "src/ng-helper/lifecycle", "src/ng-helper/require"], function (exports_5, context_5) {
    "use strict";
...
System.register("src/overlay/player-play.component", ["src/ng-helper/facade"], function (exports_6, context_6) {
    "use strict";
    var __moduleName = context_6 && context_6.id;
    var facade_1, PlayerPlay;
    return {
        setters: [
            function (facade_1_1) {
                facade_1 = facade_1_1;
        ...
        execute: function () {
            PlayerPlay = (function () {
                function PlayerPlay(elm) {
                    this.elm = elm;
                    console.log('Im in typescript :)');
                }
                PlayerPlay.prototype.ngOnInit = function () {
                    var _this = this;
                    this.youtubePlayer
                        .getPlayer()
            ...
            PlayerPlay.$inject = ['$element'];
            PlayerPlay = __decorate([
                facade_1.Component({
                    selector: 'playerPlay',
                    templateUrl: '/template/overlay/player-play.component.html',
                    link: facade_1.bindToCtrlCallOnInit(['youtubePlayer']),
                    transclude: true,
                    require: ['^youtubePlayer']
                }),
                __metadata("design:paramtypes", [Object])
            ], PlayerPlay);
            exports_6("PlayerPlay", PlayerPlay);
        }
    };
});
