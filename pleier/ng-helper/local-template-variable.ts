 ...
 */
export function localTemplateVariableLink (scope: ng.IScope, elm: ng.IAugmentedJQuery, attr: ng.IAttributes, ctrl: any[]) {
 ...
 */
export function directiveLocalTemplateVariableLink (scope: ng.IScope, elm: ng.IAugmentedJQuery, attr: ng.IAttributes, ctrl: any[]) {
    // Get the attributes that comply to the local template variable format
    getLocalTemplateVariables(attr)
...
function getLocalTemplateVariables (attr: ng.IAttributes) {
